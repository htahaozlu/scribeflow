<!--
  ...
  icon). demo.gif is generated by scripts/make-demo-gif.py (stylized) — or record a
  real run with scripts/record-demo.sh (vhs).
-->
...
<p align="center">
  <img src="docs/images/demo.gif" alt="ScribeFlow transcribing a lecture, interrupted, then resuming" width="760" />
</p>
<p align="center"><sub><em>Start a transcription, interrupt it, run the same command again — it resumes and finishes.</em></sub></p>
<p align="center"><sub>Regenerate: <code>scripts/make-demo-gif.py</code> (stylized, runs anywhere) or <code>scripts/record-demo.sh</code> (a real recording, needs <a href="https://github.com/charmbracelet/vhs">vhs</a>).</sub></p>
